        ...
        var Dialog=React.createClass({displayName: "Dialog",
            ...
            render(){
                ...
                return  React.createElement("div", {className: "dialog createLink"}, 
                    React.createElement("div", {className: "statusBar"}, 
                        React.createElement("label", {className: "title"}, "组:", this.props.title), 
                        React.createElement("div", {className: "closeBtn", onClick: this.close}, "×")
                    ), 
                    React.createElement("div", {className: "container"}, 
                        React.createElement("p", null, 
                            React.createElement("label", null, "名称 :"), 
                            React.createElement("input", {type: "text", className: "name", value: this.state.name, onChange: function(event){
                        ...
                        React.createElement("p", null, 
                            ...
                            React.createElement("input", {type: "text", value: this.state.origin, onChange: function(event){
                                event.preventDefault();
                                        self.setState({
                        ...
                        React.createElement("p", null, 
                            ...
                            React.createElement("input", {type: "text", value: this.state.target, onChange: function(event){
                                event.preventDefault();
                                        self.setState({
                ...
                var li=ary.map(function(item,index){
                    return  React.createElement("li", {key: index, className: "linkItem"}, 
                                React.createElement("div", {className: "name"}, 
                                    ...
                                    React.createElement("i", {className: "fa fa-pencil editIcon"})
                                ), 
            ...
            return  React.createElement("div", {className: "pageContent"}, 
                        React.createElement("div", {className: "catalog"}, 
                            React.createElement("div", {className: "list"}, 
                                React.createElement(GroupsToolBar, null), 
